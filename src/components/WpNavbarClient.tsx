...
export default function WpNavbarClient({ links }: { links: NavLink[] }) {
    ...
    <>
      ...
      >
        <button
          ...
          style={{ position: 'absolute', top: '24px', right: '24px', background: 'none', border: 'none', color: 'rgba(245,240,232,0.5)', fontSize: '32px', cursor: 'pointer', lineHeight: 1, transition: 'color 0.3s', fontFamily: 'var(--font-inter), sans-serif', fontWeight: 300 }}
          onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--gold)')}
